...
public enum UserErrorCode implements ErrorCode {
    ...
    PASSWORD_MISMATCH("ERR_PASSWORD_MISMATCH", "user.password.mismatch", BAD_REQUEST),
    USER_NOT_FOUND("ERR_USER_NOT_FOUND", "user.not.found", NOT_FOUND),
    ACCOUNT_ALREADY_DEACTIVATED("ERR_ACCOUNT_ALREADY_DEACTIVATED", "user.already.deactivated", BAD_REQUEST),
    ACCOUNT_ALREADY_ACTIVATED("ERR_ACCOUNT_ALREADY_ACTIVATED", "user.already.activated", BAD_REQUEST),
    INVALID_CURRENT_PASSWORD("ERR_INVALID_CURRENT_PASSWORD", "user.invalid.current.password", BAD_REQUEST),
    CHANGE_PASSWORD_MISMATCH("ERR_CHANGE_PASSWORD_MISMATCH", "user.change.password.mismatch", BAD_REQUEST);
