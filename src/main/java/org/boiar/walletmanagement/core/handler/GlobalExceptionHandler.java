...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBase(BaseException ex, HttpServletRequest req){
        String message = localeHelper.get(
        ...
        return ResponseEntity
                ...
                .body(ErrorResponse.of(ex, message, req));
    }

    // ── Bean Validation → localised field errors 
    ...
    public ResponseEntity<ErrorResponse> handleValidation(
        ...
        return ResponseEntity
                ...
                .body(ErrorResponse.ofValidation(
                        localeHelper.get("ERR_VALIDATION"),
                        fieldErrors,
                        request
                ));
    }
    ...
    private String resolveFieldMessage(org.springframework.validation.FieldError fe) {
        try {
            // fe.getDefaultMessage() =  "ERR_FIELD_REQUIRED"
